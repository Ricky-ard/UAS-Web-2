<html>
<head>
<title>PHP PDO CRUD - simpan absensi</title>
<style>
...
<body>
<div style="margin:20px 0px;text-align:right;"><a href="indexabsensi.php?save=true" class="button_link">List Karyawan</a></div>
<div class="frm-add">
<h1 class="demo-form-heading">simpan absensi</h1>
